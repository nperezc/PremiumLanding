    ...
    (function () {
      ...
      function tick() {
        ...
        if (parOn) {
          ...
          if (nx !== lastX || ny !== lastY) {
            ...
            /* mismos valores, mismo ritmo: las 4 story heredan el gesto */
            for (var s = 0; s < storyEls.length; s++) {
              storyEls[s].style.setProperty('--px', nx);
              storyEls[s].style.setProperty('--py', ny);
            }
          }
        }
      ...
      function initDock() {
        ...
        SPEC.items = [].map.call(document.querySelectorAll('[data-spec]'), function (el) {
          return {
            el: el, ang: 2.4, tAng: 2.4, br: 0, tBr: 0, focused: false,
        ...
        /* el estado is-active lo posee el scroll-spy (js/nav-spy.js): aquí
           solo soltamos el hot-clic y el estallido de polen; el href real
           navega (html:scroll-behavior smooth para las anclas) */
      ...
      function assembleRoot(limbs, opt) {
        ...
        var uni = lightUniforms({
          ...
          uMask: {
            value: new THREE.Vector4(opt.mask ? opt.mask[0] : 0, opt.mask ? opt.mask[1] : 1,
